    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: '✏️ Teks & Formatting', link: '/html/teks-formatting' },
          { text: '🖼️ Media & Link', link: '/html/media-link' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: '✨ Animations & Transitions', link: '/css/animations-transitions' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: '🗂️ 2. Object & Array', link: '/js/2-object-array' },
          ...
          { text: '🖥️ 6. DOM & Events', link: '/js/6-dom-events' },
          { text: '🌍 7. Fetch API', link: '/js/7-fetch-api' },
          { text: '🛡️ 8. Error, Module, OOP', link: '/js/8-error-module-oop' },
          { text: '💡 9. Konsep Penting', link: '/js/9-konsep-penting' },
          { text: '🧪 Testing Dasar (Vitest)', link: '/js/testing-dasar' },
          { text: '🔨 Tooling & Dev Environment', link: '/js/tooling' }
        ]
      },
      {
        text: '🛠️ Tooling & Kolaborasi',
        collapsed: false,
        items: [
      ...
      },
      {
        ...
        collapsed: false,
        items: [
          { text: '📖 Glosarium Istilah', link: '/glossary' }
        ]
      }
    ]
  }
